...
export const CHANNEL = {
  name: process.env.CHANNEL_NAME ?? 'banca-persona',
  title: process.env.CHANNEL_TITLE ?? 'Banca Persona',
  realm: process.env.CHANNEL_REALM ?? 'reino-banca-persona',
  clientId: process.env.CHANNEL_CLIENT_ID ?? 'banca-persona',
  clientSecret: process.env.CHANNEL_CLIENT_SECRET ?? 'banca-persona-secret',
};
